...
The public repository contains original source code, documentation, configuration and
...
1. `Standards/00_manifest/sources.json` contains the exact URL and archival SHA-256 for the
...
The source validator enforces that `Standards/` remains metadata-only. It does not download
