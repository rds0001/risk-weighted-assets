...
```bash
cd code && PYTHONNOUSERSITE=1 python3 -m pytest
...
- Universalbank: `daten/rechenlaeufe/2026-08-31/v1.0.0/outputs/RUN-20260831-B24BAAAB20`,
...
- KSA-Bank: `daten/rechenlaeufe/2026-08-31/v1.0.0-ksa/outputs/RUN-20260831-1E80913B9B`,
