...
def test_full_run_creates_versioned_excel_package(tmp_path: Path):
    ...
    assert {"calculation_run_id","result_version","result_as_of_date","result_knowledge_time",
            "result_rule_set_id","result_view","result_is_official"}.issubset(pillar1.columns)
